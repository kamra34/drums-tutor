    ...
    <div className="p-6 lg:p-8 max-w-[1400px] mx-auto" style={{ background: '#06080d', minHeight: '100vh' }}>
      ...
      <div className="relative mb-8 overflow-hidden rounded-3xl p-8 lg:p-10 border border-white/[0.04]" style={{
        ...
        <div className="relative z-10">
          <h1 className="text-3xl lg:text-4xl font-extrabold text-white mb-2 tracking-tight">
            Piano<span className="bg-gradient-to-r from-violet-400 to-purple-300 bg-clip-text text-transparent">.</span>
          </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          >
            <div className="absolute left-0 top-0 bottom-0 w-[3px] rounded-l-2xl" style={{ background: '#a78bfa', opacity: 0.4 }} />
            <div className="relative flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 text-2xl" style={{ backgroundColor: 'rgba(167,139,250,0.08)', border: '1px solid rgba(167,139,250,0.15)' }}>
                {card.icon}
              </div>
              <div className="flex-1">
                ...
                {card.to ? (
                  <Link to={card.to} className="mt-2 inline-flex items-center gap-1 text-xs text-violet-400/70 hover:text-violet-400 transition-colors">
                    Open →
                  </Link>
                ) : (
