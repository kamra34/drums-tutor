...
const module0Exercises: Exercise[] = [
  {
    ...
    title: 'Free Hit',
    description:
      'Hit any pad you like! This is your chance to explore the kit freely. No scoring — just get comfortable with how each pad feels and sounds.',
    order: 1,
    patternData: PATTERN_FREE_HIT,
    targetBpm: 100,
    timeSignature: [4, 4],
    bars: 4,
    difficulty: 1,
  },
  {
    ...
    title: 'Know Your Kit',
    description:
      'Follow the on-screen prompts to hit specific pads. When you see "Hit the snare!", strike the snare pad. This helps you learn where each sound lives.',
    order: 2,
